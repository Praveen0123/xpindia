...
@Component({
  selector: 'app-line-graph1',
  templateUrl: './line-graph1.component.html',
  styleUrls: ['./line-graph1.component.scss']
})
export class LineGraph1Component implements OnInit {
  public analytics: any[];
  tempArray : any[] = [];
  public showXAxis = true;
  public text = "Daily distribution of trips done by vendor";
