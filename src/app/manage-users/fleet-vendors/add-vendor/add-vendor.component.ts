...
export class AddVendorComponent implements OnInit {
  ...
  get vendorName() { return this.addCustomerForm.get('vendorName'); }
  
  get contactName() { return this.addCustomerForm.get('contactName'); }
  ...
  createCustomerForm() {
    this.addCustomerForm = this.fb.group({
      vendorName:new FormControl('',[Validators.required,Validators.maxLength(50),this.noWhiteSpaceValidator]),
      contactName:new FormControl('',[Validators.required,Validators.maxLength(50),this.noWhiteSpaceValidator]),
