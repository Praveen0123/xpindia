...
export class AddScheduledVisitComponent implements OnInit {
  ...
  constructor(public alertService:AlertService,public dialogRef: MatDialogRef<AddScheduledVisitComponent>,@Inject(MAT_DIALOG_DATA) public scheduledVisit: any) { }
