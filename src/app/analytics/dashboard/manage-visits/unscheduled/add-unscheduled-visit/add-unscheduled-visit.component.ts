...
export class AddUnscheduledVisitComponent implements OnInit {
  ...
  constructor(public alertService:AlertService,public dialogRef: MatDialogRef<AddUnscheduledVisitComponent>,@Inject(MAT_DIALOG_DATA) public unscheduledVisit: any) { }
