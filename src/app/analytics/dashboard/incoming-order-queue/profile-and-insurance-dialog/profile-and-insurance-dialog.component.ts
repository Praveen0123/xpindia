...
export class ProfileAndInsuranceDialogComponent implements OnInit {
  ...
  constructor(public alertService:AlertService,public dialogRef: MatDialogRef<ProfileAndInsuranceDialogComponent>, public fb: FormBuilder,@Inject(MAT_DIALOG_DATA) public order: any) { 
