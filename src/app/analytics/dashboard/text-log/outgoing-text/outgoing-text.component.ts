...
@Component({
  selector: 'app-outgoing-text',
  templateUrl: './outgoing-text.component.html',
  styleUrls: ['./outgoing-text.component.scss']
})
export class OutgoingTextComponent implements OnInit {
