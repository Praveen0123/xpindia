...
@Component({
  selector: 'app-h-and-psymptoms',
  templateUrl: './h-and-psymptoms.component.html',
  styleUrls: ['./h-and-psymptoms.component.scss']
})
export class HAndPSymptomsComponent implements OnInit {
