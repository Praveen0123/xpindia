...
@Component({
  selector: 'app-soap-medications-tab',
  templateUrl: './soap-medications-tab.component.html',
  styleUrls: ['./soap-medications-tab.component.scss']
})
export class SoapMedicationsTabComponent implements OnInit {
