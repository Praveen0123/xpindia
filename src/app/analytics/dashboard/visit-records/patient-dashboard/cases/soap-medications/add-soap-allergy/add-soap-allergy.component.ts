...
@Component({
  selector: 'app-add-soap-allergy',
  templateUrl: './add-soap-allergy.component.html',
  styleUrls: ['./add-soap-allergy.component.scss']
})
export class AddSoapAllergyComponent implements OnInit {
  ...
  constructor(public fb:FormBuilder,public alertService:AlertService,public dialogRef: MatDialogRef<AddSoapAllergyComponent>,@Inject(MAT_DIALOG_DATA) public allergy: any) {
