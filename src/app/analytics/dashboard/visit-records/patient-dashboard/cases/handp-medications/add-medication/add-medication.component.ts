...
export class AddMedicationComponent implements OnInit {
  ...
  constructor(public fb:FormBuilder,public alertService:AlertService,public dialogRef: MatDialogRef<AddMedicationComponent>,@Inject(MAT_DIALOG_DATA) public medication: any) {
