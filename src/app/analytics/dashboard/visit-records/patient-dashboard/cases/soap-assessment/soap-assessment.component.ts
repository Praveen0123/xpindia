...
@Component({
  selector: 'app-soap-assessment',
  templateUrl: './soap-assessment.component.html',
  styleUrls: ['./soap-assessment.component.scss']
})
export class SoapAssessmentComponent implements OnInit {
