...
@Component({
  selector: 'app-in-patient-handp',
  templateUrl: './in-patient-handp.component.html',
  styleUrls: ['./in-patient-handp.component.scss']
})
export class InPatientHandpComponent implements OnInit {
