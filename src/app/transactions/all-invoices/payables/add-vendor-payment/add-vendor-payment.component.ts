...
addUserForm:FormGroup;
  constructor(public fb:FormBuilder,public dialogRef: MatDialogRef<AddVendorPaymentComponent>,@Inject(MAT_DIALOG_DATA) public user: number, private alertService: AlertService) { 
    this.createUserForm();
  }
