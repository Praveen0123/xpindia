...
export class AddPaymentComponent implements OnInit {
  ...
  constructor(public fb:FormBuilder,public alertService:AlertService,public dialogRef: MatDialogRef<AddPaymentComponent>,@Inject(MAT_DIALOG_DATA) public attorney: any) {
