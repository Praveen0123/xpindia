...
// import { XpCustomerWebComponent } from './xp-customer-web/xp-customer-web.component';
...
@NgModule({
  ...
  declarations: [
    ...
    AddNoteDialogComponent,HelpVideoDialogComponent, UniversalFilterComponent, NewComponent, 
    ],
  entryComponents: [
    VerticalMenuComponent,
    PasswordDialogComponent,
