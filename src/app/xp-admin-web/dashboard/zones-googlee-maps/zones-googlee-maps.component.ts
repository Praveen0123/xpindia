...
@Component({
  selector: 'app-zones-googlee-maps',
  templateUrl: './zones-googlee-maps.component.html',
  styleUrls: ['./zones-googlee-maps.component.scss']
})
export class ZonesGoogleeMapsComponent {
