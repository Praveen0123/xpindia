...
@Component({
  selector: 'app-operations-googleee-maps',
  templateUrl: './operations-googleee-maps.component.html',
  styleUrls: ['./operations-googleee-maps.component.scss']
})
export class OperationsGoogleeeMapsComponent {
