...
@Component({
  selector: 'app-operations-google-maps',
  templateUrl: './operations-google-maps.component.html',
  styleUrls: ['./operations-google-maps.component.scss']
})
export class OperationsGoogleMapsComponent {
