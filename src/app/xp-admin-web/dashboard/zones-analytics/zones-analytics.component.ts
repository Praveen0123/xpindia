...
@Component({
  selector: 'app-zones-analytics',
  templateUrl: './zones-analytics.component.html',
  styleUrls: ['./zones-analytics.component.scss']
})
export class ZonesAnalyticsComponent implements OnInit {
