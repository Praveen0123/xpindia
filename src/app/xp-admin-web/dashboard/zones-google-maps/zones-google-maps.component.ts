...
@Component({
  selector: 'app-zones-google-maps',
  templateUrl: './zones-google-maps.component.html',
  styleUrls: ['./zones-google-maps.component.scss']
})
export class ZonesGoogleMapsComponent  {
