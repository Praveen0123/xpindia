...
@Component({
  ...
  templateUrl: './management-analytics.component.html',
  styleUrls: ['./management-analytics.component.scss']
})
export class ManagementAnalyticsComponent implements OnInit {
