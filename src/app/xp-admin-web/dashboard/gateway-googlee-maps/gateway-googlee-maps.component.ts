...
@Component({
  selector: 'app-gateway-googlee-maps',
  templateUrl: './gateway-googlee-maps.component.html',
  styleUrls: ['./gateway-googlee-maps.component.scss']
})
export class GatewayGoogleeMapsComponent {
