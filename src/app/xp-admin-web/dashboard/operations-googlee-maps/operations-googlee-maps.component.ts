...
@Component({
  selector: 'app-operations-googlee-maps',
  templateUrl: './operations-googlee-maps.component.html',
  styleUrls: ['./operations-googlee-maps.component.scss']
})
export class OperationsGoogleeMapsComponent {
