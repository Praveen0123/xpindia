...
@Component({
  selector: 'app-gateway-google-maps',
  templateUrl: './gateway-google-maps.component.html',
  styleUrls: ['./gateway-google-maps.component.scss']
})
export class GatewayGoogleMapsComponent {
