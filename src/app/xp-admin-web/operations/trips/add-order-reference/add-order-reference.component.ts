...
@Component({
  selector: 'app-add-order-reference',
  templateUrl: './add-order-reference.component.html',
  styleUrls: ['./add-order-reference.component.scss']
})
export class AddOrderReferenceComponent implements OnInit {
  ...
  constructor(private alertService: AlertService,public fb:FormBuilder,public dialogRef: MatDialogRef<AddOrderReferenceComponent>,@Inject(MAT_DIALOG_DATA) public attorney: any) {
  ...
  saveVehicle() {
    this.alertService.createAlert("Order Reference added successfully",1);
    this.dialogRef.close();
  }
