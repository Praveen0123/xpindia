...
import { VolumetricPie,customerPie} from '../main-customer-pie.data';
import { AppSettings } from '../../../app.settings';
import { Settings } from '../../../app.settings.model';
import { PageEvent, MatDialog } from '@angular/material';
import {AddxpcnBespokeComponent} from './addxpcn-bespoke/addxpcn-bespoke.component';
import {SelectBespokeComponent} from './select-bespoke/select-bespoke.component';
// import {AddxpcnExpressComponent} from './addxpcn-express/addxpcn-express.component';
// import {SelectColuneModalComponent} from './select-colune-modal/select-colune-modal.component';
...
export class BespokeComponent implements OnInit {
  ...
  constructor(public dialog:MatDialog,public appSettings:AppSettings) {
    ...
    Object.assign(this, {VolumetricPie,customerPie}); 
  }
  ...
  public openxpcnModal(id) {
    let dialogRef = this.dialog.open(AddxpcnBespokeComponent, {
      data:id,
      height: 'auto',
      width: '600px',
      autoFocus: false
  ...
  public openManageGridModal(id) {
    let dialogRef = this.dialog.open(SelectBespokeComponent, {
      data:id,
      height: 'auto',
      width: '600px',
      autoFocus: false
