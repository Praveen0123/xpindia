...
import { MasterInLclComponent } from './master-in-lcl/master-in-lcl.component';
...
@NgModule({
  declarations: [BookingComponent, InTransitComponent, DeliveryComponent, MasterInLclComponent],
  imports: [
    CommonModule,
    MasterModule,
    // HttpClientModule,
