...
@Component({
  selector: 'app-add-fcl-model-rates',
  templateUrl: './add-fcl-model-rates.component.html',
  styleUrls: ['./add-fcl-model-rates.component.scss']
})
export class AddFClMOdelRatesComponent implements OnInit {

  addCustomerForm:FormGroup;
  capacityOfVehicle = "";
  
  constructor(public fb:FormBuilder,public dialogRef: MatDialogRef<AddFClMOdelRatesComponent>,@Inject(MAT_DIALOG_DATA) public user: number, private alertService: AlertService) { 
