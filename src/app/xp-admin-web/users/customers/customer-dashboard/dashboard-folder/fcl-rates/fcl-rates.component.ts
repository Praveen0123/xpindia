...
import { AddFclRatesCustomerDashboardComponent } from './add-fcl-rates-customer-dashboard/add-fcl-rates-customer-dashboard.component'
...
export class FclRatesComponent implements OnInit {
  ...
  public openFCLRatesDialog(customer) {
    let dialogRef = this.dialog.open(AddFclRatesCustomerDashboardComponent, {
      data:customer,
      height: 'auto',
      width: '600px',
      autoFocus: false
