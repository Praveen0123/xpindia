...
import { AddDestinationCustomerDashboardComponent } from './add-destination-customer-dashboard/add-destination-customer-dashboard.component';
...
export class DestinationsComponent implements OnInit {
  ...
  public openOriginDialog(customer) {
    let dialogRef = this.dialog.open(AddDestinationCustomerDashboardComponent, {
      data:customer,
      height: 'auto',
      width: '600px',
      autoFocus: false
