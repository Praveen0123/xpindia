...
export class AddCustomerComponent implements OnInit {
  ...
  constructor(public fb:FormBuilder,public dialogRef: MatDialogRef<AddCustomerComponent>,@Inject(MAT_DIALOG_DATA) public user: number, private alertService: AlertService) { 
