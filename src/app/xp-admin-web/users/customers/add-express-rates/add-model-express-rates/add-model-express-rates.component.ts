...
@Component({
  selector: 'app-add-model-express-rates',
  templateUrl: './add-model-express-rates.component.html',
  styleUrls: ['./add-model-express-rates.component.scss']
})
export class AddModelExpressRatesComponent implements OnInit {

  addCustomerForm:FormGroup;
  capacityOfVehicle = "";
  
  constructor(public fb:FormBuilder,public dialogRef: MatDialogRef<AddModelExpressRatesComponent>,@Inject(MAT_DIALOG_DATA) public user: number, private alertService: AlertService) { 
