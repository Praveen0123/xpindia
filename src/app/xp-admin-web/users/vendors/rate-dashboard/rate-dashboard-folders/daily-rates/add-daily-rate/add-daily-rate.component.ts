...
@Component({
  selector: 'app-add-daily-rate',
  templateUrl: './add-daily-rate.component.html',
  styleUrls: ['./add-daily-rate.component.scss']
})
export class AddDailyRateComponent implements OnInit {

  addCustomerForm:FormGroup;
  capacityOfVehicle = "";
  
  constructor(public fb:FormBuilder,public dialogRef: MatDialogRef<AddDailyRateComponent>,@Inject(MAT_DIALOG_DATA) public user: number, private alertService: AlertService) { 
