...
@Component({
  ...
  styleUrls: ['./line-graph2.component.scss']
})
export class LineGraph2Component implements OnInit {
  public analytics: any[];
  tempArray : any[] = [];
  public showXAxis = true;
  public text = "Distribution of number of login seesions";
  ...
  ngOnInit() {
    ...
    var scheduledObj = { name: "Logins", series: [] };
    for (var i = 1; i <= 31; i++) {
