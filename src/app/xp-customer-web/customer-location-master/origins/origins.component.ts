...
import { AddCustomerOriginComponent } from './add-customer-origin/add-customer-origin.component';
...
export class OriginsComponent implements OnInit {
  ...
  deleteOrigin() {
    this.alertService.createAlert("Origin deleted successfully",1);
  }

  public openoriginDialog(location) {
    let dialogRef = this.dialog.open(AddCustomerOriginComponent,{
      data:location,
      height:'auto',
      width:'600px',
      autoFocus:false
