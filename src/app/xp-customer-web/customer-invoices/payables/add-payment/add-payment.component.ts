...
export class AddPaymentComponent implements OnInit {
  ...
  constructor( public alertService:AlertService, public fb:FormBuilder,public dialogRef: MatDialogRef<AddPaymentComponent>,@Inject(MAT_DIALOG_DATA) public attorney: any) {
